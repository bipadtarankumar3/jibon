...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="app-ecommerce">
            ...
            <div class="row">
                <form action="{{URL::To('admin/highlits/edit-action',$highlit->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <!-- First column-->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="property_id" id="state" class="form-control">
                                            ...
                                            @foreach ($properties as $propertie)
                                                <option value="{{ $propertie->id }}" @if($propertie->id ==$highlit->property_id ) selected @endif>{{ $propertie->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{$highlit->title}}" class="form-control" placeholder="Enter Property Highlits"
                                                name="title">
                                        </div>
                                    </div>
